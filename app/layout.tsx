...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered species identification for Jalisco biodiversity research. Verified against GBIF, iNaturalist, and CONABIO databases.",
  ...
  openGraph: {
    ...
    description:
      "AI-powered species identification verified against GBIF, iNaturalist, and CONABIO. Built for conservation biologists in Jalisco, Mexico.",
    siteName: "BioJalisco",
    locale: "en_US",
    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* Set the theme before first paint to avoid a flash of the wrong
            theme on refresh. Mirrors the logic in ThemeProvider. */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('biojalisco-theme');if(t!=='light'&&t!=='dark'){t=window.matchMedia('(prefers-color-scheme: light)').matches?'light':'dark';}document.documentElement.setAttribute('data-theme',t);}catch(e){}})();`,
          }}
        />
